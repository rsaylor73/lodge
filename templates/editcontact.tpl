...
<table class="table">
	...
	<tr><td><b>Date Of Birth: (MM/DD/YYYY)</b></td><td><input type="text" name="dob" value="{$date_of_birth}"  {literal} maxlength="10" pattern="[0-9]{2}/[0-9{2}/[0-9]{4}" {/literal} required placeholder="MM/DD/YYYY" class="date" size=40></td></tr>
