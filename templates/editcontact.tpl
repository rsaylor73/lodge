...
<table class="table">
	...
	<tr><td><b>Date Of Birth: (YYYYMMDD)</b></td><td><input type="text" name="dob" value="{$date_of_birth}"  {literal} maxlength="8" pattern="[0-9]{8}" {/literal} required placeholder="YYYYMMDD" class="date" size=40></td></tr>
